...
func (c *client) Handlers() map[string]http.HandlerFunc {
	...
	routes := map[string]http.HandlerFunc{
		...
		"/api/v1/garage/cars/mods/uploads":                    c.garage.GetModUploads,
		"/api/v1/garage/cars/mods/uploads/add":                middleware.RequireAuth(c.garage.AddModUpload),
		"DELETE /api/v1/garage/cars/mods/uploads/remove":      middleware.RequireAuth(c.garage.RemoveModUpload),
